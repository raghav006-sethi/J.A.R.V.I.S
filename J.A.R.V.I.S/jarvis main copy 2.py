...
def calc(query):
    ...
    if 'add' in query or 'plus' in query:pass
    elif 'minus' in query or 'subtract' in query:pass
    elif 'multiply' in query or 'into' in query :pass
    elif 'devide' in query:pass
    elif 'log' in query:pass
    elif 'to the power' in query:pass
    elif 'sine' in query:pass
    elif 'cos' in query:pass
    elif 'tan' in query:pass
    elif 'factorial' in query:pass
    pass
